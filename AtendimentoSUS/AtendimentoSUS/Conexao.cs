...
namespace AtendimentoSUS
{
    class Conexao
    {
        ...
        public void open()
        {
            ...
            {
                conecta.ConnectionString = ("Server=localhost;Database=bd_recepcao;User=root;pwd=vertrigo");
                //conecta.ConnectionString = ("server=10.67.48.3;Database=BD_JukeBox;User=aluno;Pwd=etec@147");
                conecta.Open();
            }
        }
